								...
								<c:forEach items="${allOrders}" var="o" varStatus="status">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td style="CURSOR: hand; HEIGHT: 22px" align="center"
												...
												<c:if test="${o.state==2}">
													<a href="/store_hmx/AdminOrderServlet?method=updateOrderByOid&oid=${o.oid}">发货</a>
												</c:if>
											...
											<td align="center" style="HEIGHT: 22px" width="60%">
												...
												<table border="1" width="100%">
												   ...
												   <tr><td><img src="/store_hmx/products/1/c_0001.jpg" width="50px"/></td><td>XXX</td><td>XXX</td><td>XXX</td></tr>
												   
												   <tr>
												   	<td><img src="/store_hmx/products/1/c_0001.jpg" width="50px"/></td>
												    <td>XXX</td>
												    <td>XXX</td>
												    <td>XXX</td>
												   </tr> 
...
$(function(){
	...
	$(".myClass").click(function(){
		...
		if(txt=="订单详情"){
			...
			var url="/store_hmx/AdminOrderServlet";
			...
			$.post(url,obj,function(data){
				...
				$.each(data,function(i,obj){
					var td="<tr><td><img src='/store_hmx/"+obj.product.pimage+"' width='50px'/></td><td>"+obj.product.pname+"</td><td>"+obj.product.shop_price+"</td><td>"+obj.quantity+"</td></tr>";
					$tb.append(td);				
				})
			},"json");
