...
import com.atzhizuobiao.store.service.UserService;
import com.atzhizuobiao.store.service.serviceImp.CategoryServiceImp;
import com.atzhizuobiao.store.service.serviceImp.UserServiceImp;
import com.atzhizuobiao.store.utils.MailUtils;
import com.atzhizuobiao.store.utils.MyBeanUtils;
...
public class UserServlet extends BaseServlet {
	...
	public String userLogin(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			response.sendRedirect("/store_hmx/index.jsp");
			return null;
		} catch (Exception e) {
			//用户登录失败
